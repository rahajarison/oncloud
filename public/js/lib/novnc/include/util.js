...
Util.get_include_uri = function() {
    // return (typeof INCLUDE_URI !== "undefined") ? INCLUDE_URI : "/js/lib/novnc/include/";
    return '/js/lib/novnc/include/';
}
Util._loading_scripts = [];
Util._pending_scripts = [];
Util.load_scripts = function(files) {
    console.log('Util: loadScripts()');
